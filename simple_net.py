...
class Net:
    def __init__(self, INPUT_DIMENSION, OUTPUT_DIMENSION, TRAINING_RUNS, BATCH_SIZE, VERF_SIZE):
        ...
        self.W = tf.Variable(tf.zeros([self.INPUT_DIMENSION, self.OUTPUT_DIMENSION]))
        self.b = tf.Variable(tf.zeros([self.OUTPUT_DIMENSION]))
        ...
        self.train_step = tf.train.GradientDescentOptimizer(0.12).minimize(self.loss)
